...
component {
	...
	// Module Properties
	this.title 				= "solanaApi";
	this.author 			= "The CFSolana Team";
	this.webURL 			= "https://cfsolana.com";
	this.description 		= "Solana API";
	this.version			= "0.1.0";
	...
	// Module Entry Point
	this.entryPoint			= "solanaApi";
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "solanaApiName";
	// CF Mapping
	this.cfmapping			= "solanaApiMapping";
	// Auto-map models
